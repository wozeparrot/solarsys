...
stdenv.mkDerivation (finalAttrs: {
  pname = "reaper-reaimgui-extension";
  version = "0.10.0.5";
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-qFY5Yc7Nl3h9ay3AsBQYXSxHLAZ8C+f+ZkfOlA93TcU=";
  ...
  postPatch = ''
    ...
    substituteInPlace tools/meson.build --replace-fail "0.0-nogit" "${finalAttrs.version}"
  '';
