...
static const struct xkb_rule_names xkb_rules = {
	/* can specify fields: rules, model, layout, variant, options */	/* example:
	.options = "ctrl:nocaps",
	*/
};
...
static const char *menucmd[] = { "fuzzel -r 0 -b 1a1a1aff -t f8f8f2ff -s 6272a4ff -C a968ffff -m e83c6aff -w 40 -l 12", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_b,          setlayout,        {.v = &layouts[2]} },
